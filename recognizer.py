...
def face_recognizer(name):
    ...
    while True:
        ...
        # ret, i_img = i_vid.read()
        # ret, r_img = r_vid.read()

        # frame = cv2.hconcat([i_img, r_img])
        ...
        for (x, y, w, h) in faces:
            ...
            pred = 0
            if confidence > 50:
                # if you want to print confidence level
                # confidence = 100 - int(confidence)
                # print(confidence)
